...
// Notice: 	Requires libglfw3 wrapper to be present in the same namespace!
//			If changes are desired to the class name of the libglfw3 wrapper, please make the appropriate changes over at:
//			"#Methods, static OpenGL(), #Assert context", line 3809
//			"#Methods, static OpenGL(), #Link delegates", line 3815

// Notice:	Static constructor requires a GLFW context to be present, if any OpenGL function is called before a valid context is present an exception will be thrown!
...
public static unsafe class OpenGL
{
	...
	public delegate void PFNGLVERTEXPOINTEREXTPROC( int size, uint type, int stride, int count, void* pointer );
	public delegate void PFNGLNORMALPOINTEREXTPROC( uint type, int stride, int count, void* pointer );
	public delegate void PFNGLCOLORPOINTEREXTPROC( int size, uint type, int stride, int count, void* pointer );
	public delegate void PFNGLINDEXPOINTEREXTPROC( uint type, int stride, int count, void* pointer );
	public delegate void PFNGLTEXCOORDPOINTEREXTPROC( int size, uint type, int stride, int count, void* pointer );
	public delegate void PFNGLEDGEFLAGPOINTEREXTPROC( int stride, int count, [In] [MarshalAs( UnmanagedType.LPStr )] string pointer );
	public delegate void PFNGLGETPOINTERVEXTPROC( uint pname, void** parameters );
	public delegate void PFNGLARRAYELEMENTARRAYEXTPROC( uint mode, int count, void* pi );
	public delegate void PFNGLDRAWRANGEELEMENTSWINPROC( uint mode, uint start, uint end, int count, uint type, void* indices );
	public delegate void PFNGLADDSWAPHINTRECTWINPROC( int x, int y, int width, int height );
	public delegate void PFNGLCOLORTABLEEXTPROC( uint target, uint internalFormat, int width, uint format, uint type, void* data );
	public delegate void PFNGLCOLORSUBTABLEEXTPROC( uint target, int start, int count, uint format, uint type, void* data );
	public delegate void PFNGLGETCOLORTABLEEXTPROC( uint target, uint format, uint type, void* data );
	...
	public delegate byte PFNGLARETEXTURESRESIDENTPROC( int n, uint[] textures, void* residences );
	...
	public delegate void PFNGLEDGEFLAGPOINTERPROC( int stride, void* pointer );
	...
	public delegate void PFNGLGETBOOLEANVPROC( uint pname, void* parameters );
	...
	public delegate void PFNGLGETPOINTERVPROC( uint pname, void** parameters );
	public delegate void PFNGLGETPOLYGONSTIPPLEPROC( void* mask );
	...
	public delegate void PFNGLINDEXPOINTERPROC( uint type, int stride, void* pointer );
	...
	public delegate void PFNGLINTERLEAVEDARRAYSPROC( uint format, int stride, void* pointer );
	...
	public delegate void* PFNGLGETSTRINGPROC( uint name );
	#endregion
	...
	public delegate void PFNGLPOINTPARAMETERFVPROC( uint pname, float* parameters );
	public delegate void PFNGLPOINTPARAMETERIPROC( uint pname, int param );
	public delegate void PFNGLPOINTPARAMETERIVPROC( uint pname, int* parameters );
	...
	public delegate void PFNGLGETQUERYIVPROC( uint target, uint pname, int* parameters );
	public delegate void PFNGLGETQUERYOBJECTIVPROC( uint id, uint pname, int* parameters );
	public delegate void PFNGLGETQUERYOBJECTUIVPROC( uint id, uint pname, uint* parameters );
	...
	public delegate void PFNGLGETBUFFERPARAMETERIVPROC( uint target, uint pname, int* parameters );
	public delegate void PFNGLGETBUFFERPOINTERVPROC( uint target, uint pname, void** parameters );
	#endregion
	...
	public delegate void PFNGLGETACTIVEATTRIBPROC( uint program, uint index, int bufSize, int* length, int* size, uint* type, void* name );
	public delegate void PFNGLGETACTIVEUNIFORMPROC( uint program, uint index, int bufSize, int* length, int* size, uint* type, void* name );
	...
	public delegate void PFNGLGETPROGRAMIVPROC( uint program, uint pname, int* parameters );
	public delegate void PFNGLGETPROGRAMINFOLOGPROC( uint program, int bufSize, int* length, void* infoLog );
	public delegate void PFNGLGETSHADERIVPROC( uint shader, uint pname, int* parameters );
	public delegate void PFNGLGETSHADERINFOLOGPROC( uint shader, int bufSize, int* length, void* infoLog );
	public delegate void PFNGLGETSHADERSOURCEPROC( uint shader, int bufSize, int* length, void* source );
	public delegate int PFNGLGETUNIFORMLOCATIONPROC( uint program, [In] [MarshalAs( UnmanagedType.LPStr )] string name );
	public delegate void PFNGLGETUNIFORMFVPROC( uint program, int location, float* parameters );
	public delegate void PFNGLGETUNIFORMIVPROC( uint program, int location, int* parameters );
	public delegate void PFNGLGETVERTEXATTRIBDVPROC( uint index, uint pname, double* parameters );
	public delegate void PFNGLGETVERTEXATTRIBFVPROC( uint index, uint pname, float* parameters );
	public delegate void PFNGLGETVERTEXATTRIBIVPROC( uint index, uint pname, int* parameters );
	...
	public delegate void PFNGLSHADERSOURCEPROC( uint shader, int count, void** str, int* length );
	...
	public delegate void PFNGLUNIFORMMATRIX2FVPROC( int location, int count, byte transpose, float* value );
	public delegate void PFNGLUNIFORMMATRIX3FVPROC( int location, int count, byte transpose, float* value );
	public delegate void PFNGLUNIFORMMATRIX4FVPROC( int location, int count, byte transpose, float* value );
	...
	public delegate void PFNGLVERTEXATTRIBPOINTERPROC( uint index, int size, uint type, byte normalized, int stride, void* pointer );
	#endregion
	...
	#region Delegates
	public delegate void PFNGLUNIFORMMATRIX2X3FVPROC( int location, int count, byte transpose, float* value );
	public delegate void PFNGLUNIFORMMATRIX3X2FVPROC( int location, int count, byte transpose, float* value );
	public delegate void PFNGLUNIFORMMATRIX2X4FVPROC( int location, int count, byte transpose, float* value );
	public delegate void PFNGLUNIFORMMATRIX4X2FVPROC( int location, int count, byte transpose, float* value );
	public delegate void PFNGLUNIFORMMATRIX3X4FVPROC( int location, int count, byte transpose, float* value );
	public delegate void PFNGLUNIFORMMATRIX4X3FVPROC( int location, int count, byte transpose, float* value );
	#endregion
	...
	public delegate void PFNGLGETBOOLEANI_VPROC( uint target, uint index, void* data );
	...
	public delegate void PFNGLTRANSFORMFEEDBACKVARYINGSPROC( uint program, int count, void* varyings, uint bufferMode );
	public delegate void PFNGLGETTRANSFORMFEEDBACKVARYINGPROC( uint program, uint index, int bufSize, int* length, int* size, uint* type, void* name );
	...
	public delegate void PFNGLGETVERTEXATTRIBIIVPROC( uint index, uint pname, int* parameters );
	public delegate void PFNGLGETVERTEXATTRIBIUIVPROC( uint index, uint pname, uint* parameters );
	...
	public delegate void PFNGLGETUNIFORMUIVPROC( uint program, int location, uint* parameters );
	...
	public delegate void PFNGLTEXPARAMETERIIVPROC( uint target, uint pname, int* parameters );
	public delegate void PFNGLTEXPARAMETERIUIVPROC( uint target, uint pname, uint* parameters );
	public delegate void PFNGLGETTEXPARAMETERIIVPROC( uint target, uint pname, int* parameters );
	public delegate void PFNGLGETTEXPARAMETERIUIVPROC( uint target, uint pname, uint* parameters );
	...
	public delegate void* PFNGLGETSTRINGIPROC( uint name, uint index );
	...
	public delegate void PFNGLGETRENDERBUFFERPARAMETERIVPROC( uint target, uint pname, int* parameters );
	...
	public delegate void PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC( uint target, uint attachment, uint pname, int* parameters );
	...
	public delegate void PFNGLGETUNIFORMINDICESPROC( uint program, int uniformCount, void* uniformNames, uint* uniformIndices );
	public delegate void PFNGLGETACTIVEUNIFORMSIVPROC( uint program, int uniformCount, uint* uniformIndices, uint pname, int* parameters );
	public delegate void PFNGLGETACTIVEUNIFORMNAMEPROC( uint program, uint uniformIndex, int bufSize, int* length, void* uniformName );
	public delegate uint PFNGLGETUNIFORMBLOCKINDEXPROC( uint program, [In] [MarshalAs( UnmanagedType.LPStr )] string uniformBlockName );
	public delegate void PFNGLGETACTIVEUNIFORMBLOCKIVPROC( uint program, uint uniformBlockIndex, uint pname, int* parameters );
	public delegate void PFNGLGETACTIVEUNIFORMBLOCKNAMEPROC( uint program, uint uniformBlockIndex, int bufSize, int* length, void* uniformBlockName );
	...
	public delegate void* PFNGLFENCESYNCPROC( uint condition, uint flags );
	public delegate byte PFNGLISSYNCPROC( void* sync );
	public delegate void PFNGLDELETESYNCPROC( void* sync );
	public delegate uint PFNGLCLIENTWAITSYNCPROC( void* sync, uint flags, uint timeout );
	public delegate void PFNGLWAITSYNCPROC( void* sync, uint flags, uint timeout );
	public delegate void PFNGLGETINTEGER64VPROC( uint pname, int* data );
	public delegate void PFNGLGETSYNCIVPROC( void* sync, uint pname, int bufSize, int* length, int* values );
	public delegate void PFNGLGETINTEGER64I_VPROC( uint target, uint index, int* data );
	public delegate void PFNGLGETBUFFERPARAMETERI64VPROC( uint target, uint pname, int* parameters );
	...
	public delegate void PFNGLGETSAMPLERPARAMETERIVPROC( uint sampler, uint pname, int* parameters );
	public delegate void PFNGLGETSAMPLERPARAMETERIIVPROC( uint sampler, uint pname, int* parameters );
	public delegate void PFNGLGETSAMPLERPARAMETERFVPROC( uint sampler, uint pname, float* parameters );
	public delegate void PFNGLGETSAMPLERPARAMETERIUIVPROC( uint sampler, uint pname, uint* parameters );
	public delegate void PFNGLQUERYCOUNTERPROC( uint id, uint target );
	public delegate void PFNGLGETQUERYOBJECTI64VPROC( uint id, uint pname, int* parameters );
	public delegate void PFNGLGETQUERYOBJECTUI64VPROC( uint id, uint pname, uint* parameters );
	...
	public delegate void PFNGLVERTEXATTRIBP1UIVPROC( uint index, uint type, byte normalized, uint* value );
	public delegate void PFNGLVERTEXATTRIBP2UIPROC( uint index, uint type, byte normalized, uint value );
	public delegate void PFNGLVERTEXATTRIBP2UIVPROC( uint index, uint type, byte normalized, uint* value );
	public delegate void PFNGLVERTEXATTRIBP3UIPROC( uint index, uint type, byte normalized, uint value );
	public delegate void PFNGLVERTEXATTRIBP3UIVPROC( uint index, uint type, byte normalized, uint* value );
	public delegate void PFNGLVERTEXATTRIBP4UIPROC( uint index, uint type, byte normalized, uint value );
	public delegate void PFNGLVERTEXATTRIBP4UIVPROC( uint index, uint type, byte normalized, uint* value );
	#endregion
	...
	public delegate void PFNGLUNIFORMMATRIX2DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLUNIFORMMATRIX3DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLUNIFORMMATRIX4DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLUNIFORMMATRIX2X3DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLUNIFORMMATRIX2X4DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLUNIFORMMATRIX3X2DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLUNIFORMMATRIX3X4DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLUNIFORMMATRIX4X2DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLUNIFORMMATRIX4X3DVPROC( int location, int count, byte transpose, double* value );
	public delegate void PFNGLGETUNIFORMDVPROC( uint program, int location, double* parameters );
	...
	public delegate void PFNGLGETACTIVESUBROUTINEUNIFORMNAMEPROC( uint program, uint shadertype, uint index, int bufsize, int* length, void* name );
	public delegate void PFNGLGETACTIVESUBROUTINENAMEPROC( uint program, uint shadertype, uint index, int bufsize, int* length, void* name );
	public delegate void PFNGLUNIFORMSUBROUTINESUIVPROC( uint shadertype, int count, uint* indices );
	public delegate void PFNGLGETUNIFORMSUBROUTINEUIVPROC( uint shadertype, int location, uint* parameters );
	...
	public delegate void PFNGLGETQUERYINDEXEDIVPROC( uint target, uint index, uint pname, int* parameters );
	#endregion
	...
	public delegate uint PFNGLCREATESHADERPROGRAMVPROC( uint type, int count, void* strings );
	...
	public delegate void PFNGLGETPROGRAMPIPELINEIVPROC( uint pipeline, uint pname, int* parameters );
	...
	public delegate void PFNGLPROGRAMUNIFORMMATRIX2FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX3FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX4FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX2DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX3DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX4DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX2X3FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX3X2FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX2X4FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX4X2FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX3X4FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX4X3FVPROC( uint program, int location, int count, byte transpose, float* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX2X3DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX3X2DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX2X4DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX4X2DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX3X4DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLPROGRAMUNIFORMMATRIX4X3DVPROC( uint program, int location, int count, byte transpose, double* value );
	public delegate void PFNGLVALIDATEPROGRAMPIPELINEPROC( uint pipeline );
	public delegate void PFNGLGETPROGRAMPIPELINEINFOLOGPROC( uint pipeline, int bufSize, int* length, void* infoLog );
	...
	public delegate void PFNGLGETVERTEXATTRIBLDVPROC( uint index, uint pname, double* parameters );
	...
	public delegate void PFNGLGETINTERNALFORMATIVPROC( uint target, uint internalformat, uint pname, int bufSize, int* parameters );
	public delegate void PFNGLGETACTIVEATOMICCOUNTERBUFFERIVPROC( uint program, uint bufferIndex, uint pname, int* parameters );
	...
	#region Delegates
	public delegate void GLDEBUGPROC( uint source, uint type, uint id, uint severity, int length, [In] [MarshalAs( UnmanagedType.LPStr )] string message, void* userParam );
	...
	public delegate void PFNGLGETFRAMEBUFFERPARAMETERIVPROC( uint target, uint pname, int* parameters );
	public delegate void PFNGLGETINTERNALFORMATI64VPROC( uint target, uint internalformat, uint pname, int bufSize, int* parameters );
	...
	public delegate void PFNGLGETPROGRAMINTERFACEIVPROC( uint program, uint programInterface, uint pname, int* parameters );
	...
	public delegate void PFNGLGETPROGRAMRESOURCENAMEPROC( uint program, uint programInterface, uint index, int bufSize, int* length, void* name );
	public delegate void PFNGLGETPROGRAMRESOURCEIVPROC( uint program, uint programInterface, uint index, int propCount, uint* props, int bufSize, int* length, int* parameters );
	...
	public delegate void PFNGLDEBUGMESSAGECONTROLPROC( uint source, uint type, uint severity, int count, uint* ids, byte enabled );
	...
	public delegate uint PFNGLGETDEBUGMESSAGELOGPROC( uint count, int bufSize, uint* sources, uint* types, uint* ids, uint* severities, int* lengths, void* messageLog );
	...
	public delegate void PFNGLGETOBJECTLABELPROC( uint identifier, uint name, int bufSize, int* length, void* label );
	public delegate void PFNGLOBJECTPTRLABELPROC( void* ptr, int length, [In] [MarshalAs( UnmanagedType.LPStr )] string label );
	public delegate void PFNGLGETOBJECTPTRLABELPROC( void* ptr, int bufSize, int* length, void* label );
	#endregion
	...
	public delegate void PFNGLGETTRANSFORMFEEDBACKI64_VPROC( uint xfb, uint pname, uint index, int* param );
	...
	public delegate void PFNGLGETNAMEDBUFFERPARAMETERIVPROC( uint buffer, uint pname, int* parameters );
	public delegate void PFNGLGETNAMEDBUFFERPARAMETERI64VPROC( uint buffer, uint pname, int* parameters );
	public delegate void PFNGLGETNAMEDBUFFERPOINTERVPROC( uint buffer, uint pname, void** parameters );
	...
	public delegate void PFNGLGETNAMEDFRAMEBUFFERATTACHMENTPARAMETERIVPROC( uint framebuffer, uint attachment, uint pname, int* parameters );
	...
	public delegate void PFNGLGETNAMEDRENDERBUFFERPARAMETERIVPROC( uint renderbuffer, uint pname, int* parameters );
	...
	public delegate void PFNGLTEXTUREPARAMETERIIVPROC( uint texture, uint pname, int* parameters );
	public delegate void PFNGLTEXTUREPARAMETERIUIVPROC( uint texture, uint pname, uint* parameters );
	...
	public delegate void PFNGLGETTEXTURELEVELPARAMETERFVPROC( uint texture, int level, uint pname, float* parameters );
	public delegate void PFNGLGETTEXTURELEVELPARAMETERIVPROC( uint texture, int level, uint pname, int* parameters );
	public delegate void PFNGLGETTEXTUREPARAMETERFVPROC( uint texture, uint pname, float* parameters );
	public delegate void PFNGLGETTEXTUREPARAMETERIIVPROC( uint texture, uint pname, int* parameters );
	public delegate void PFNGLGETTEXTUREPARAMETERIUIVPROC( uint texture, uint pname, uint* parameters );
	public delegate void PFNGLGETTEXTUREPARAMETERIVPROC( uint texture, uint pname, int* parameters );
	...
	public delegate void PFNGLGETVERTEXARRAYINDEXED64IVPROC( uint vaobj, uint index, uint pname, int* param );
	...
	public delegate void PFNGLGETNUNIFORMDVPROC( uint program, int location, int bufSize, double* parameters );
	public delegate void PFNGLGETNUNIFORMFVPROC( uint program, int location, int bufSize, float* parameters );
	public delegate void PFNGLGETNUNIFORMIVPROC( uint program, int location, int bufSize, int* parameters );
	public delegate void PFNGLGETNUNIFORMUIVPROC( uint program, int location, int bufSize, uint* parameters );
	...
	public static ushort Version { get; }
	#endregion
	...
	static OpenGL()
	{
		...
		foreach( FieldInfo fi in fields )
		{
			...
			{
				IntPtr ptr = (IntPtr)GLFW3.glfwGetProcAddress( fi.Name );
...
#if DEBUG
		Console.WriteLine( "OpenGL {0}", Version );
		Console.WriteLine( "\t|" );
		Console.WriteLine( "\t-> (0x{0})", Marshal.GetFunctionPointerForDelegate( glAccum ).ToString( "X16" ) );
		Console.WriteLine();
#endif
	}
	#endregion
